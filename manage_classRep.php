        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Manage Class Representatives </li>
                </ol>
            </nav>
            <!-- Container -->
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="database"></i></span></span>Manage Class Reps in your department</h4>
                </div>
                <!-- Row -->
                <div class="row">
                    <div class="col-xl-12">
                                        ...
                                        <table id="datable_1" class="table table-hover w-100 display pb-30">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="edit_cRep.php?id=<?php echo base64_encode($row['id']);?>" data-toggle="tooltip" data-original-title="Edit"> <i class="icon-pencil"></i> </a>
                                                        <a href="manage_classRep.php?del=<?php echo base64_encode($row['id']);?>" data-toggle="tooltip" data-original-title="Delete" onclick="return confirm('Do you really want to delete?');"> <i class="icon-trash txt-danger"></i> </a>
                                                    </td>
                                                </tr>
                                                <?php 
                                                $cnt++;
