...
if (strlen($_SESSION['user_id']) == 0) {
    ...
    // Fetch all lecturers in the same department as the logged-in user
        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="users"></i></span></span>View Lecturers</h4>
                </div>
                <!-- Row -->
                <div class="row">
                    <div class="col-xl-12">
