...
if (strlen($_SESSION['user_id']) == 0) {
    ...
    // Fetch students with the same department_id as the logged-in user
    $query = "SELECT students.id, students.servNo, students.name, students.phone, students.email, classes.class_name 
              FROM students 
        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="database"></i></span></span>Manage Students</h4>
                </div>
                <!-- Row -->
                <div class="row">
                    <div class="col-xl-12">
                                        ...
                                        <table id="datable_1" class="table table-hover w-100 display pb-30">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="edit_student.php?id=<?php echo base64_encode($row['id']);?>" data-toggle="tooltip" data-original-title="Edit"> <i class="icon-pencil"></i> </a>
                                                        <a href="manage_students.php?del=<?php echo base64_encode($row['id']);?>" data-toggle="tooltip" data-original-title="Delete" onclick="return confirm('Do you really want to delete?');"> <i class="icon-trash txt-danger"></i> </a>
                                                    </td>
                                                </tr>
                                                <?php 
                                                $cnt++;
