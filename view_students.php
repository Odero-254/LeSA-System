...
if (strlen($_SESSION['user_id']) == 0) {
    ...
    $userQuery = $conn->prepare("SELECT class_id FROM users WHERE id = ?");
    $userQuery->bind_param("i", $user_id);
    $userQuery->execute();
    $userQuery->bind_result($class_id);
    $userQuery->fetch();
    $userQuery->close();

    // Fetch students whose class_id matches that of the logged-in user
    $query = "SELECT id, servNo, name, phone, email FROM students WHERE class_id = ?";
        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="database"></i></span></span>View Students</h4>
                </div>
                <!-- Row -->
                <div class="row">
                    <div class="col-xl-12">
